...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public void setSlewRates(double x_val, double y_val, double rot_val) 
  {
    SlewRateLimiter x = new SlewRateLimiter(x_val);
    SlewRateLimiter y = new SlewRateLimiter(y_val);
    SlewRateLimiter rot = new SlewRateLimiter(rot_val);
    getSwerveController().addSlewRateLimiters(x, y, rot);
  }
}
